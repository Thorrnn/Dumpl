    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-body">
                        <h4 class="text-bold">Середне значення бальної оцінки зручності стилю розбиття інформації на блоки</h4>
                        <img class="text-center" src="{{ $ComfortWorkingOrdersImageUrl }}"/>
                    </div>
                </div>
            </div>
            <div class="col-12">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                @forelse($dataComfortWorking as $stat)
                                    @php
                                        $class = '';
                                    @endphp
                                    <tr>
